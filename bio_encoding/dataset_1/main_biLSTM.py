...
def run(load_embeddings, embedding_dim, embeddings_path, Model, name, number_epochs):
    ...
    with open("val_dataset.json", "r") as file:
    ...
    for epoch in range(number_epochs):
        ...
        train_macro_f1 = f1_score(
            ...
            np.concatenate(all_train_preds, axis=0),
            average="macro",
        )
    ...
    plt.plot(range(1, number_epochs + 1), train_losses, label="Training Loss")
    plt.plot(range(1, number_epochs + 1), val_losses, label="Validation Loss")
    plt.xlabel("Epochs")
    plt.ylabel("Loss")
    ...
    plt.figure(figsize=(10, 5))
    plt.plot(range(1, number_epochs + 1), train_f1_scores, label="Training Macro-F1")
    plt.plot(range(1, number_epochs + 1), val_f1_scores, label="Validation Macro-F1")
    plt.xlabel("Epochs")
